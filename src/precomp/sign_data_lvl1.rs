...
pub fn extremal_orders() -> &'static [QuatPExtremalMaximalOrder; 7] {
    ...
    V.get_or_init(|| [
            ...
            QuatPExtremalMaximalOrder { order: QuatLattice { denom: ibz_lit(false, &[0x0,0x1000000000000000]), basis: [[ibz_lit(false, &[0x0,0x1000000000000000]),Ibz::new(),ibz_lit(false, &[0x0,0x800000000000000]),Ibz::new()],[Ibz::new(),ibz_lit(true, &[0x1]),Ibz::new(),ibz_lit(true, &[0x0,0x0,0x0,0x80000000000000])],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x0,0x800000000000000]),Ibz::new()],[Ibz::new(),ibz_lit(true, &[0x1]),Ibz::new(),Ibz::new()]] }, z: QuatAlgElem { denom: ibz_lit(false, &[0x0,0x1000000000000000]), coord: [Ibz::new(),ibz_lit(true, &[0x1]),Ibz::new(),ibz_lit(true, &[0x1])] }, t: QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()] }, q: 5 },
            QuatPExtremalMaximalOrder { order: QuatLattice { denom: ibz_lit(false, &[0xf5f27a647b8578d4,0xb8746101369629b9]), basis: [[ibz_lit(false, &[0xf5f27a647b8578d4,0xb8746101369629b9]),Ibz::new(),ibz_lit(false, &[0xfaf93d323dc2bc6a,0x5c3a30809b4b14dc]),Ibz::new()],[Ibz::new(),ibz_lit(false, &[0x95ad2ad56fa47d47,0xc89877e749be8a4b,0x1]),Ibz::new(),ibz_lit(false, &[0x3e355e2970603f47,0x78dd10ae2a1bd950,0x0,0x280000000000000])],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0xfaf93d323dc2bc6a,0x5c3a30809b4b14dc]),Ibz::new()],[Ibz::new(),ibz_lit(false, &[0x11]),Ibz::new(),ibz_lit(true, &[0xb19426e828ee3fe7,0xd6de568af586d7a])]] }, z: QuatAlgElem { denom: ibz_lit(false, &[0xf5f27a647b8578d4,0xb8746101369629b9]), coord: [Ibz::new(),ibz_lit(false, &[0x95ad2ad56fa47d47,0xc89877e749be8a4b,0x1]),Ibz::new(),ibz_lit(false, &[0x11])] }, t: QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()] }, q: 17 },
            QuatPExtremalMaximalOrder { order: QuatLattice { denom: ibz_lit(false, &[0x3c6fa8e67715e5e2,0x17949bec872b9078]), basis: [[ibz_lit(false, &[0x3c6fa8e67715e5e2,0x17949bec872b9078]),Ibz::new(),ibz_lit(false, &[0x1e37d4733b8af2f1,0xbca4df64395c83c]),Ibz::new()],[Ibz::new(),ibz_lit(true, &[0xb034808274c8307a,0x9ab399ac43a4e8a]),Ibz::new(),ibz_lit(false, &[0x3d25ca466bc9954f,0x4f5822946ed431b,0xeb3e45306eb3e453,0x45306eb3e45306])],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1e37d4733b8af2f1,0xbca4df64395c83c]),Ibz::new()],[Ibz::new(),ibz_lit(false, &[0x4]),Ibz::new(),ibz_lit(false, &[0xbd312454ca3a0e7f,0x2172f0cb4ce562])]] }, z: QuatAlgElem { denom: ibz_lit(false, &[0x3c6fa8e67715e5e2,0x17949bec872b9078]), coord: [Ibz::new(),ibz_lit(true, &[0xb034808274c8307a,0x9ab399ac43a4e8a]),Ibz::new(),ibz_lit(false, &[0x4])] }, t: QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()] }, q: 37 },
            QuatPExtremalMaximalOrder { order: QuatLattice { denom: ibz_lit(false, &[0xde33c5116deeafa2,0x2df94f97c89ec8ce]), basis: [[ibz_lit(false, &[0xde33c5116deeafa2,0x2df94f97c89ec8ce]),Ibz::new(),ibz_lit(false, &[0x6f19e288b6f757d1,0x16fca7cbe44f6467]),Ibz::new()],[Ibz::new(),ibz_lit(false, &[0xd17aa943da6bdd36,0x44d44b0c564ce307]),Ibz::new(),ibz_lit(true, &[0xa0a2047cc4063a03,0x6cee07961df46dbc,0xc7ce0c7ce0c7ce0c,0x7ce0c7ce0c7ce0])],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x6f19e288b6f757d1,0x16fca7cbe44f6467]),Ibz::new()],[Ibz::new(),ibz_lit(true, &[0x8]),Ibz::new(),ibz_lit(true, &[0xd9f82148a1e2188f,0xd6e1b21a072e79])]] }, z: QuatAlgElem { denom: ibz_lit(false, &[0xde33c5116deeafa2,0x2df94f97c89ec8ce]), coord: [Ibz::new(),ibz_lit(false, &[0xd17aa943da6bdd36,0x44d44b0c564ce307]),Ibz::new(),ibz_lit(true, &[0x8])] }, t: QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()] }, q: 41 },
            QuatPExtremalMaximalOrder { order: QuatLattice { denom: ibz_lit(false, &[0x380014f2025b96a4,0x7bbeab7f79584e7c,0x1]), basis: [[ibz_lit(false, &[0x380014f2025b96a4,0x7bbeab7f79584e7c,0x1]),Ibz::new(),ibz_lit(false, &[0x1c000a79012dcb52,0xbddf55bfbcac273e]),Ibz::new()],[Ibz::new(),ibz_lit(true, &[0x4ba119e7333973e3,0xdbd0ee6227026ebc,0x7]),Ibz::new(),ibz_lit(false, &[0x9f01d923dd0ca33,0x83f7e395afe92f81,0xfffffffffffffffc,0x27fffffffffffff])],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1c000a79012dcb52,0xbddf55bfbcac273e]),Ibz::new()],[Ibz::new(),ibz_lit(false, &[0x35]),Ibz::new(),ibz_lit(false, &[0x87f571c0f93ceb73,0x12fab9cbcb3c667a])]] }, z: QuatAlgElem { denom: ibz_lit(false, &[0x380014f2025b96a4,0x7bbeab7f79584e7c,0x1]), coord: [Ibz::new(),ibz_lit(true, &[0x4ba119e7333973e3,0xdbd0ee6227026ebc,0x7]),Ibz::new(),ibz_lit(false, &[0x35])] }, t: QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()] }, q: 53 },
            QuatPExtremalMaximalOrder { order: QuatLattice { denom: ibz_lit(false, &[0xe2b97b9e55af7ffa,0xc227f76b578ca7af,0xf]), basis: [[ibz_lit(false, &[0xe2b97b9e55af7ffa,0xc227f76b578ca7af,0xf]),Ibz::new(),ibz_lit(false, &[0xf15cbdcf2ad7bffd,0xe113fbb5abc653d7,0x7]),Ibz::new()],[Ibz::new(),ibz_lit(true, &[0xa2ef1ce7f02b0d16,0x66759632c56054b,0x6f]),Ibz::new(),ibz_lit(false, &[0x84ac06ea9d3bf0ab,0xd021882bdde962e5,0xffffffffffffffe2,0x13ffffffffffffff])],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0xf15cbdcf2ad7bffd,0xe113fbb5abc653d7,0x7]),Ibz::new()],[Ibz::new(),ibz_lit(false, &[0x308]),Ibz::new(),ibz_lit(false, &[0x77013f15c4a1f37,0x9281da3156007183])]] }, z: QuatAlgElem { denom: ibz_lit(false, &[0xe2b97b9e55af7ffa,0xc227f76b578ca7af,0xf]), coord: [Ibz::new(),ibz_lit(true, &[0xa2ef1ce7f02b0d16,0x66759632c56054b,0x6f]),Ibz::new(),ibz_lit(false, &[0x308])] }, t: QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()] }, q: 97 }
        ])
}
...
pub fn connecting_ideals() -> &'static [QuatLeftIdeal; 7] {
    ...
    V.get_or_init(|| [
            ...
            QuatLeftIdeal { lattice: QuatLattice { denom: ibz_lit(false, &[0x2]), basis: [[ibz_lit(false, &[0x2,0x6000000000000000]),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1,0x1000000000000000])],[Ibz::new(),ibz_lit(false, &[0x2,0x6000000000000000]),ibz_lit(false, &[0x1,0x5000000000000000]),Ibz::new()],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()],[Ibz::new(),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1])]] }, norm: ibz_lit(false, &[0x1,0x3000000000000000]), parent_order: Some(maxord_o0()) },
            QuatLeftIdeal { lattice: QuatLattice { denom: ibz_lit(false, &[0x2]), basis: [[ibz_lit(false, &[0x7f90157b8673f5fe,0x78f4a646d00bd2c5]),Ibz::new(),Ibz::new(),ibz_lit(false, &[0xe65cd6d8002bfee5,0x5b1373de72d68a3])],[Ibz::new(),ibz_lit(false, &[0x7f90157b8673f5fe,0x78f4a646d00bd2c5]),ibz_lit(false, &[0x99333ea38647f719,0x73436f08e8de6a21]),Ibz::new()],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()],[Ibz::new(),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1])]] }, norm: ibz_lit(false, &[0xbfc80abdc339faff,0x3c7a53236805e962]), parent_order: Some(maxord_o0()) },
            QuatLeftIdeal { lattice: QuatLattice { denom: ibz_lit(false, &[0x2]), basis: [[ibz_lit(false, &[0x3c6fa8e67715e5e2,0x17949bec872b9078]),Ibz::new(),Ibz::new(),ibz_lit(false, &[0xbb290a5a3af78597,0x84ff561d2d977c0])],[Ibz::new(),ibz_lit(false, &[0x3c6fa8e67715e5e2,0x17949bec872b9078]),ibz_lit(false, &[0x81469e8c3c1e604b,0xf44a68ab45218b7]),Ibz::new()],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()],[Ibz::new(),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1])]] }, norm: ibz_lit(false, &[0x1e37d4733b8af2f1,0xbca4df64395c83c]), parent_order: Some(maxord_o0()) },
            QuatLeftIdeal { lattice: QuatLattice { denom: ibz_lit(false, &[0x2]), basis: [[ibz_lit(false, &[0xde33c5116deeafa2,0x2df94f97c89ec8ce]),Ibz::new(),Ibz::new(),ibz_lit(false, &[0xd5f5cdcaa90b519b,0xe59b35483dd757a])],[Ibz::new(),ibz_lit(false, &[0xde33c5116deeafa2,0x2df94f97c89ec8ce]),ibz_lit(false, &[0x83df746c4e35e07,0x1f9f9c4344c15354]),Ibz::new()],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()],[Ibz::new(),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1])]] }, norm: ibz_lit(false, &[0x6f19e288b6f757d1,0x16fca7cbe44f6467]), parent_order: Some(maxord_o0()) },
            QuatLeftIdeal { lattice: QuatLattice { denom: ibz_lit(false, &[0x2]), basis: [[ibz_lit(false, &[0x52a2ee77559419f2,0xb348218745c9f459]),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1df48a96967adbd3,0x222419a0d707845])],[Ibz::new(),ibz_lit(false, &[0x52a2ee77559419f2,0xb348218745c9f459]),ibz_lit(false, &[0x34ae63e0bf193e1f,0xb125dfed38597c14]),Ibz::new()],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()],[Ibz::new(),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1])]] }, norm: ibz_lit(false, &[0xa951773baaca0cf9,0x59a410c3a2e4fa2c]), parent_order: Some(maxord_o0()) },
            QuatLeftIdeal { lattice: QuatLattice { denom: ibz_lit(false, &[0x2]), basis: [[ibz_lit(false, &[0xd0316ad767cfaa3a,0x2996d852ebca0701]),Ibz::new(),Ibz::new(),ibz_lit(false, &[0xbc67edebd7ab0275,0x148ef2e5aeb5ad41])],[Ibz::new(),ibz_lit(false, &[0xd0316ad767cfaa3a,0x2996d852ebca0701]),ibz_lit(false, &[0x13c97ceb9024a7c5,0x1507e56d3d1459c0]),Ibz::new()],[Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1]),Ibz::new()],[Ibz::new(),Ibz::new(),Ibz::new(),ibz_lit(false, &[0x1])]] }, norm: ibz_lit(false, &[0xe818b56bb3e7d51d,0x14cb6c2975e50380]), parent_order: Some(maxord_o0()) }
        ])
}
pub fn conjugating_elements() -> &'static [QuatAlgElem; 7] {
    ...
    V.get_or_init(|| [
            ...
            QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [ibz_lit(false, &[0x1e37d4733b8af2f1,0xbca4df64395c83c]),ibz_lit(true, &[0x1e37d4733b8af2f1,0xbca4df64395c83c]),Ibz::new(),Ibz::new()] },
            QuatAlgElem { denom: ibz_lit(false, &[0x1]), coord: [ibz_lit(false, &[0x6f19e288b6f757d1,0x16fca7cbe44f6467]),ibz_lit(true, &[0x6f19e288b6f757d1,0x16fca7cbe44f6467]),Ibz::new(),Ibz::new()] },
