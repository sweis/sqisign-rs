...
//! Precomputed signing-path constants (lvl3).
...
pub const QUAT_REPRES_BOUND_INPUT: usize = 21;
pub const QUAT_EQUIV_BOUND_COEFF: usize = 64;
pub const FINDUV_BOX_SIZE: usize = 3;
pub const FINDUV_CUBE_SIZE: usize = 2400;

// --- quaternion_data.c ---
pub fn quat_prime_cofactor() -> &'static Ibz {
    static V: OnceLock<Ibz> = OnceLock::new();
    V.get_or_init(|| ibz_lit(false, &[0x171, 0x0, 0x0, 0x0, 0x0, 0x8000000000000000]))
}
...
pub const NUM_ALTERNATE_STARTING_CURVES: usize = 7;
pub fn extremal_orders() -> &'static [QuatPExtremalMaximalOrder; 8] {
    static V: OnceLock<[QuatPExtremalMaximalOrder; 8]> = OnceLock::new();
    V.get_or_init(|| {
        [
                ...
                order: QuatLattice {
                    ...
                    basis: [
                        ...
                        [
                            ...
                            ibz_lit(
                                true,
                                &[0x843690644aa81e5f, 0xdd152fd850ab8fae, 0x3d794238343617a],
                            ),
                        ],
                    ],
                },
                ...
                order: QuatLattice {
                    ...
                    basis: [
                        ...
                        [
                            ...
                            ibz_lit(
                                true,
                                &[0xa4cf343c41358400, 0x5ac7c207a4146603, 0x6cf01edd084921b],
                            ),
                        ],
                    ],
                },
                ...
                order: QuatLattice {
                    ...
                    basis: [
                        ...
                        [
                            ...
                            ibz_lit(
                                true,
                                &[0x2e5272f1ea6fe8e2, 0xfd0e5fe4c137152a, 0xc6bfa3d07a19736],
                            ),
                            Ibz::new(),
                            ibz_lit(
                                false,
                ...
                order: QuatLattice {
                    ...
                    basis: [
                        ...
                        [
                            ...
                            ibz_lit(
                                true,
                                &[0x130f681e08a773ba, 0xf78b4ebed966eee3, 0x245c4090fa9ba4d],
                            ),
                        ],
                    ],
                },
                ...
                order: QuatLattice {
                    ...
                    basis: [
                        ...
                        [
                            ...
                            ibz_lit(
                                true,
                                &[0x51231b920986b5ab, 0xc0fd4896653b4b2a, 0xf7d20ec06c579e],
                            ),
                        ],
                    ],
                },
...
pub fn connecting_ideals() -> &'static [QuatLeftIdeal; 8] {
    static V: OnceLock<[QuatLeftIdeal; 8]> = OnceLock::new();
    V.get_or_init(|| {
        [
            QuatLeftIdeal {
                lattice: QuatLattice {
...
pub fn conjugating_elements() -> &'static [QuatAlgElem; 8] {
    static V: OnceLock<[QuatAlgElem; 8]> = OnceLock::new();
    V.get_or_init(|| {
        [
            QuatAlgElem {
                denom: ibz_lit(false, &[0x1]),
...
pub fn curves_with_endomorphisms() -> &'static [CurveWithEndomorphismRing; 8] {
    static V: OnceLock<[CurveWithEndomorphismRing; 8]> = OnceLock::new();
    V.get_or_init(|| {
        [
            CurveWithEndomorphismRing {
                curve: EcCurve {
                    a: Fp2 {
                        re: Fp([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
                        im: Fp([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
                    },
                    c: Fp2 {
                        re: Fp([0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe400000000000]),
                        im: Fp([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
                    },
                    a24: EcPoint {
                        x: Fp2 {
                            re: Fp([0x3, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf400000000000]),
                            im: Fp([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
                        },
                        z: Fp2 {
                            re: Fp([0x7, 0x0, 0x0, 0x0, 0x0, 0x0, 0xe400000000000]),
