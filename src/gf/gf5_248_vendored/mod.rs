...
pub struct GF5_248(pub(crate) [u64; 4]);
...
impl GF5_248 {
    ...
    // Square this value n times (in place). Outlined so the loop is not
    // unrolled into a multi-kilobyte addition chain at every call site.
    #[inline(never)]
